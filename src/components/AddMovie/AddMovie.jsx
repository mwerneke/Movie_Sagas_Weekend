...
const postMovie =()=>{  //Runs the detail that are taken in form and delivers to index.js
    dispatch({
        type: 'POST_MOVIE',
        payload: {
            title:title,
...
const handleTitle=(event)=>{  //Handling Input for Title
...
const handleBackBtn =()=>{   //Sends user Back to MovieList (Main)
    history.push('/')
}
    ...
    return (
        ...
        <div>
            <form name= "frm" onSubmit={postMovie}>
                <input className="title" onChange={handleTitle} placeholder="Movie Title"/> 
                <br/>        
                <input className="description" onChange={handleDescription} placeholder="Movie Description"/>   
                <br/> 
                <input className="url" onChange={handleUrl} placeholder="Movie Image Url"/>
                <br/>
