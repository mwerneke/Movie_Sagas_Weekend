...
function* detail(action) {   //Setup intially to get movie clicked on (Details) for Details page
...
function* fetchAllMovies() {   //Provided 
...
const movieDetail = (state = [], action) => {
  if (action.type === 'SET_MOVIES') { // This is accessed at Details page for setting movie details
